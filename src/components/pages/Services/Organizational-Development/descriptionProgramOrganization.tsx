     ...
     return (
          <TabServices>
               <h1>Organizational Development</h1>
                    <section className="grid grid-rows-3 grid-flow-col gap-2">
                         ...
                         <section key={index} className="flex flex-col *:normal-case gap-1 font-normal bg-secondary rounded-lg p-4">
                              ...
                              <p className="px-4 text-[18px] text-black">
                                   {data.description}
                              </p>
                         </section>
                         )}
                         <section className="row-span-3 flex flex-col items-center justify-center h-full">
