...
export default function CapacityBuildingEventsPerDay(){
     ...
     <TabServices>
          <div className="md:text-left text-center">
               ...
               <h4 className="md:text-[24px]">Fasilitas Layanan Capacity Building Paket Perhari</h4>
          </div>
            <section className="md:grid flex flex-col-reverse grid-rows-1 grid-flow-col gap-3">
               ...
               <section>
                    <DirectionAwareHover imageUrl={'/assets/images/eo/capBuilding/cap_3.jpeg'} imageClassName="w-[40rem] h-[35rem]">
                         <p className="font-bold md:text-xl text-sm">Capacity Building with Campus Innovate</p>
